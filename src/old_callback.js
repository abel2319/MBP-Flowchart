            ...
            mousedowncbChild: (e) => {
                ...
                if (e.srcElement.getAttribute("href") === "./Images/circle.png"){
                    //if (cp2.form.c_svg.getAttribute("class") === "0") {
                        ...
                        var x = Number(cp2.form.c_points[1].c_svg.getAttribute("cx"));
                        var y = Number(cp2.form.c_points[1].c_svg.getAttribute("cy")); 
                        var dx = Number(next.component.form.c_points[3].c_svg.getAttribute("cx")); 
                        var dy = Number(next.component.form.c_points[3].c_svg.getAttribute("cy"));
                    ...
                    if (cp2.form.c_svg.getAttribute("class") === "0") {
                        if (cp2.type === "circle")
                            var next = new Action("action", Number(e.srcElement.getAttribute("x")) + 80, Number(e.srcElement.getAttribute("y")) - 35, 50, 50);
                        else
                            var next = new Action("action", Number(e.srcElement.getAttribute("x")) - 80, Number(e.srcElement.getAttribute("y")) + 75, 50, 50);
                        ...
                        var next = new Action("action", Number(e.srcElement.getAttribute("x")) + 90, Number(e.srcElement.getAttribute("y")) + 50);
                        var x = Number(cp2.form.c_points[2].c_svg.getAttribute("cx"));
                        var y = Number(cp2.form.c_points[2].c_svg.getAttribute("cy")); 
                        var dx = Number(next.component.form.c_points[1].c_svg.getAttribute("cx")); 
                        var dy = Number(next.component.form.c_points[1].c_svg.getAttribute("cy"));
                    ...
                    if (cp2.form.c_svg.getAttribute("class") === "0") {
                        if (cp2.type === "circle")
                            var next = new Gateway("exclusive", Number(e.srcElement.getAttribute("x")) + 80, Number(e.srcElement.getAttribute("y")) - 35, 40, 40);
                        else
                            var next = new Gateway("exclusive", Number(e.srcElement.getAttribute("x")) - 80, Number(e.srcElement.getAttribute("y")) + 75, 40, 40);
                        var x = Number(cp2.form.c_points[2].c_svg.getAttribute("cx"));
                        var y = Number(cp2.form.c_points[2].c_svg.getAttribute("cy")); 
                        var dx = Number(next.component.form.c_points[1].c_svg.getAttribute("cx")); 
                        var dy = Number(next.component.form.c_points[1].c_svg.getAttribute("cy"));
                        ...
                        var next = new Gateway("exclusive", Number(e.srcElement.getAttribute("x")) + 90, Number(e.srcElement.getAttribute("y")) + 50);
                        var x = Number(cp2.form.c_points[2].c_svg.getAttribute("cx"));
                        var y = Number(cp2.form.c_points[2].c_svg.getAttribute("cy")); 
                        var dx = Number(next.component.form.c_points[1].c_svg.getAttribute("cx")); 
                        var dy = Number(next.component.form.c_points[1].c_svg.getAttribute("cy"));
                ...
                line.draw();
                var link = aya.Link(cp2.form.c_points[2], next.component.form.c_points[3], line);
                link.redraw();
            },
            mouseovercb: (e) => {
